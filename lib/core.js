...
ChangeTip = {
	init: function() {
		...
		me.dialogForm.appendChild(me.monikerSelector);
		me.dialogForm.appendChild(me.monikerSelectorButton);
	...
	addSelectedMoniker: function() {
		...
		ChangeTip.dialogInput.value = 'a ' + ChangeTip.monikerSelector.options[idx].value;
	},

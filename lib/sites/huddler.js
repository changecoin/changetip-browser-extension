addModule('huddler', function(module, moduleID) {
	...
	module.oneTimeTip = true; // this module uses one time tips instead of native / mention tips.
	...
	module.init = function() {
		...
		if (isForumPage || isGalleryPage || isUserPage || isComposePage) {
			...
			$("body").delegate(".yui3-widget.yui3-panel .cke_editable, #main-container.messages-section .cke_editable, #privatemessage-compose-form textarea", "focus", module.handleEditorFocus);
	...
	module.focusTextareaWhenReady = function() {
		var $textarea = $('.yui3-widget.yui3-panel .cke_editable, .messages-section .cke_editable, .yui3-basiceditor textarea');
